...
ensureColumn('users', 'assigned_roles_json', "TEXT NOT NULL DEFAULT '[]'")
...
ensureColumn('users', 'offline_access_enabled', 'INTEGER NOT NULL DEFAULT 0')
ensureColumn('users', 'offline_pin_salt', 'TEXT')
ensureColumn('users', 'offline_pin_hash', 'TEXT')
ensureColumn('users', 'offline_pin_updated_at', 'TEXT')
ensureColumn('users', 'offline_failed_attempts', 'INTEGER NOT NULL DEFAULT 0')
ensureColumn('users', 'offline_locked_until', 'TEXT')
ensureColumn('sync_outbox', 'last_error_code', 'TEXT')
ensureColumn('sync_outbox', 'failure_category', 'TEXT')
ensureColumn('sync_outbox', 'last_error_at', 'TEXT')
ensureColumn('sync_outbox', 'next_retry_at', 'TEXT')
ensureColumn('sync_outbox', 'manual_intervention_required', 'INTEGER NOT NULL DEFAULT 0')
...
ensureColumn('sales', 'insurance_covered_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sales', 'insurance_top_up_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sales', 'insurance_top_up_payment_method', 'TEXT')
ensureColumn('sales', 'nhis_covered_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sales', 'nhis_top_up_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sales', 'private_non_nhis_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sales', 'nhis_policy_adjustment_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sales', 'nhis_top_up_policy', 'TEXT')
ensureColumn('sales', 'patient_payment_method', 'TEXT')
ensureColumn('sale_items', 'nhis_settlement', 'TEXT')
ensureColumn('sale_items', 'nhis_covered_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sale_items', 'patient_top_up_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sale_items', 'private_amount', 'REAL NOT NULL DEFAULT 0')
ensureColumn('sale_items', 'policy_adjustment_amount', 'REAL NOT NULL DEFAULT 0')
...
ensureColumn('nhia_claims', 'encounter_outcome', 'TEXT')
ensureColumn('nhia_claims', 'no_medicine_reason', 'TEXT')
ensureColumn('nhia_claims', 'no_lab_reason', 'TEXT')
ensureColumn('nhia_claims', 'no_procedure_reason', 'TEXT')
ensureColumn('nhia_claims', 'external_prescription_status', 'TEXT')
