-- Forward correction: drugs.batch_number is varchar(100), while this RPC
-- declares text. Cast explicitly to avoid PostgreSQL 42804 during RETURN QUERY.
-- No data, permissions, or stock-selection rules are changed.
