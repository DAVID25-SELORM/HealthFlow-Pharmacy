-- Repair event-only claim recycling without deleting inventory ledger history.
-- Apply after the September serving foundation; older recycle snapshots remain valid.
begin;
