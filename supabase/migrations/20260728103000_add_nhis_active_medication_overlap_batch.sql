-- Batch wrapper for the active-medication overlap advisory.
-- This keeps export scrub checks to one RPC call from the browser while reusing
-- the existing single-item read-only function.
